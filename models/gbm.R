...
with(mlflow_start_run(), {
  ...
  n.trees = mlflow_param("n.trees", 2000, "numeric")
  interaction.depth = mlflow_param("interaction.depth", 3, "numeric")
  n.minobsinnode = mlflow_param("n.minobsinnode", 1000, "numeric")
  shrinkage = mlflow_param("shrinkage", 0.01, "numeric")
  bag.fraction = mlflow_param("bag.fraction", 0.5, "numeric")
  train.fraction = mlflow_param("train.fraction", 1, "numeric")
